        ...
        >
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
                <div className="rounded-2xl border border-[#dde2ef] bg-white p-4">
                    <p className="text-xs uppercase tracking-[0.16em] text-[#8f93a9]">Clients actifs</p>
                    <p className="mt-3 text-4xl font-bold">{summary.active}</p>
                </div>
                <div className="rounded-2xl border border-[#dde2ef] bg-white p-4">
                    <p className="text-xs uppercase tracking-[0.16em] text-[#8f93a9]">Prospects</p>
                    <p className="mt-3 text-4xl font-bold">{summary.prospects}</p>
                </div>
                <div className="rounded-2xl border border-[#dde2ef] bg-white p-4">
                    <p className="text-xs uppercase tracking-[0.16em] text-[#8f93a9]">Interactions</p>
