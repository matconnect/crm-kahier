        ...
        <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
            <article className="rounded-lg border border-[#dfe3ec] bg-white p-5 shadow-[0_16px_42px_rgba(28,35,54,0.06)] md:p-6">
                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                    <div className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] p-4">
                        <p className="text-sm font-semibold text-[#141722]">Clients</p>
                        <p className="mt-2 text-3xl font-semibold text-[#1f2335]">{summary.active}</p>
                    </div>
                    <div className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] p-4">
                        <p className="text-sm font-semibold text-[#141722]">Prospects</p>
                        <p className="mt-2 text-3xl font-semibold text-[#1f2335]">{summary.prospects}</p>
                    </div>
                    <div className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] p-4">
                        <p className="text-sm font-semibold text-[#141722]">Conversion</p>
                        <p className="mt-2 text-3xl font-semibold text-[#1f2335]">{conversionRate}%</p>
                    </div>
                    <div className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] p-4">
                        <p className="text-sm font-semibold text-[#141722]">Projets</p>
                        <p className="mt-2 text-3xl font-semibold text-[#1f2335]">{projects.length}</p>
                    </div>
                </div>

                <div className="mt-6 grid gap-5 lg:grid-cols-2">
                    <div className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] p-4">
                        <p className="text-sm font-semibold text-[#141722]">{cadenceLabel(period)}</p>
                        <div className="mt-4 flex items-end gap-2 overflow-x-auto overflow-y-visible pb-1 pt-12">
                            {weekly.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="flex h-[170px] w-full items-end rounded-lg bg-[#edf0f7] p-1">
                                        <div
                    ...
                    <div className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] p-4">
                        <p className="text-sm font-semibold text-[#141722]">Interactions</p>
            ...
            <div className="space-y-5">
                <article className="rounded-lg border border-[#dfe3ec] bg-white p-5 shadow-[0_16px_42px_rgba(28,35,54,0.06)] md:p-6">
                    <p className="text-sm font-semibold text-[#141722]">Clients suivis</p>
                    <div className="mt-4 space-y-3">
                        {topClients.length === 0 ? (
                            <p className="text-sm text-[#7d8399]">Aucun client</p>
                        ) : (
                            topClients.map((client) => (
                                <div key={client.id} className="rounded-lg border border-[#e4e7f2] bg-[#f8f9fd] px-3 py-2">
                ...
                <article className="rounded-lg border border-[#dfe3ec] bg-white p-5 shadow-[0_16px_42px_rgba(28,35,54,0.06)] md:p-6">
                    <p className="text-sm font-semibold text-[#141722]">Charge projets</p>
                    <div className="mt-4 space-y-3">
